...
- inertial period is `2π/|f|`; cyclonic wind-stress curl pumps upward in the northern hemisphere and reverses south of the equator;
- basin spin-up time `H/√(2K|f|)` is shorter than vertical diffusion `H²/K`; a bottom Ekman layer carries equal-and-opposite transport to the surface layer.
