...
// writeCase writes a JSON case file into a temp dir and returns its path.
...
// runCLI runs run() with the given args, capturing stdout and stderr.
...
func TestRunProfileSouthHemisphere(t *testing.T) {
	// A southern-hemisphere case must report a leftward surface deflection:
	// easterly wind, heading 45 (northeast) instead of 135.
