...
// KernelProfile aliases the last sampled spiral; callers must copy.
var KernelProfile []Point

func attachKernelProfile(points []Point) {
	KernelProfile = points
}
